                    ...
                    <tbody>
                        {urls.length > 0 ? (
                            ...
                            urls.map((item: any, index: number) => (
                                <tr key={index} className="border-white border-2 justify-between ">
                                    <td className="border border-2 p-4 text-center w-2">
                                        {index + 1}
                                    </td>
                                    <td className="border-2  text-center w-7 px-8">
                                        {item.url}
                                    </td>
                                    <td className="border-blackborder-2 p-4 hover:text-teal-700">
                                        {item.shorturl}
                                    </td>
