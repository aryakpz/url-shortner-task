...
return(
    <div className="w-full bg-teal-950">
        <nav className="flex max-w-8xl justify-end font-lucida font-bold text-white text-lg ">
             ...
             <NavLink to={'/        <Route path='/dashboard' element={<Dashboard/>}/>
'} className="p-3  hover:text-teal-950 hover:bg-white active:transform active:[scale:0.98]">Dashboard</NavLink>
        </nav>
    </div>
)}