    ...
    return (
        <div className="w-full bg-teal-950">
            <nav className="flex max-w-8xl justify-between font-lucida font-bold text-white text-lg ">
                <div>
                    <NavLink to={'/'} className="p-6 hover:text-teal-950 hover:bg-white active:transform active:[scale:0.98]" >Login</NavLink>
                </div>
                <div>
                    <NavLink to={'/home'} className="p-5 hover:text-teal-950 hover:bg-white active:transform active:[scale:0.98]">Home</NavLink>
